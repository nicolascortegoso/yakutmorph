...
```
суруй^V^NMLZ+PL+POSS.1PL
```

Here, the verbal root 'write' (^V) is followed by a participle affix (^NMLZ), the plural affix (+PL), and the possessive suffix for the first person plural (+POSS.1PL).
