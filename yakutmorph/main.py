...
from .transducers import YakutTransducerPipeline, PostPipeline
...
class YakutMorph:
    ...
    def __init__(self,
        ...
        self.transducer = transducer if transducer else YakutTransducerPipeline()
        self.disambiguation_model = disambiguation_model if disambiguation_model else YakutModel()
        self.mapper = mapper if mapper else YakutMapper('data/mappings.yaml')
